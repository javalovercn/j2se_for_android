...
public class JSlider extends JComponent implements SwingConstants, Accessible {
	...
	private void initBar() {
		...
		updateToSeekBar();
//		sb.setProgressDrawable(ActivityManager.getActivity().getResources().getDrawable(
//				HCRUtil.getResource(HCRUtil.R_drawable_progress_bar)));
    ...
    public void setModel(BoundedRangeModel newModel) {
        if(newModel.getMinimum() != 0){
        	LogManager.errToLog("javax.swing.JSlider must set min to zero in Android server, there is a difference with standard J2SE.");
        }
