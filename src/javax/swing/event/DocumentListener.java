 ...
 * notified via the mutating thread. <em>This means that if asynchronous updates
 * are made, the implementation of this interface must be threadsafe</em>!
 * <p>
 ...
 * must be notified prior to making further mutations to the Document. <em>This
 * means implementations of the DocumentListener may not mutate the source of
 * the event (i.e. the associated Document)</em>.
 *
