...
public class DefaultHighlighter extends LayeredHighlighter {
    ...
    public Object addHighlight(int startIdx, int endIdx, Highlighter.HighlightPainter p) throws BadLocationException {
        if (startIdx < 0) {
    ...
    public static final LayeredHighlighter.LayerPainter DefaultPainter = null;//new DefaultHighlightPainter(null);
