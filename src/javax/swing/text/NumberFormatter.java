 ...
 * nubers, eg <code>setAllowsInvalid(false)</code>):
 * <ul>
 ...
 * force the DecimalFormat to contain at least one decimal
 * (<code>#.0###</code>), or allow the value to be invalid
 * <code>setAllowsInvalid(true)</code>. Otherwise users may not be able to input
 * decimal values.
 * <p>
...
public class NumberFormatter extends InternationalFormatter {
	 ...
	 * <code>valueClass</code> is one of <code>Integer</code>,
	 * <code>Long</code>, <code>Float</code>, <code>Double</code>,
	 * <code>Byte</code> or <code>Short</code> and <code>value</code> is an
	 * instanceof <code>Number</code>.
	 */
	...
	/**
	 * Subclassed to make the decimal separator navigatable, as well as making
	 * the character between the integer field and the next field navigatable.
	 */
