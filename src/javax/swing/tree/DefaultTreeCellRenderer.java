...
public class DefaultTreeCellRenderer extends JLabel implements TreeCellRenderer
{
    ...
    public void updateUI() {
        ...
        if (!inited || (getClosedIcon() instanceof UIResource)) {
            setClosedIcon(hc.android.DefaultLookup.getIcon(hc.android.DefaultLookup.TREE_CLOSEDICON));
        }
        ...
        if (!inited || (getTextSelectionColor() instanceof UIResource)) {
            setTextSelectionColor(
            		hc.android.DefaultLookup.getColor(hc.android.DefaultLookup.TREE_SELECTIONFOREGROUND));
        }
        if (!inited || (getTextNonSelectionColor() instanceof UIResource)) {
            setTextNonSelectionColor(
            		hc.android.DefaultLookup.getColor(hc.android.DefaultLookup.TREE_TEXTFOREGROUND));
        }
        if (!inited || (getBackgroundSelectionColor() instanceof UIResource)) {
            setBackgroundSelectionColor(
            		hc.android.DefaultLookup.getColor(hc.android.DefaultLookup.TREE_SELECTIONBACKGROUND));
        }
        if (!inited ||
                (getBackgroundNonSelectionColor() instanceof UIResource)) {
            setBackgroundNonSelectionColor(
            		hc.android.DefaultLookup.getColor(hc.android.DefaultLookup.TREE_TEXTBACKGROUND));
        }
