...
//		System.out.println("DefaultDialogInputFont size : " + adjustFontSize);
	 ...
	 * @param view
	 * @param font
	 * @param shiftSize 负数:表示在指定字体尺寸上向小偏移。正数:在指定字体尺寸上向大偏移
	 */
	public static void setTextSize(TextView view, Font font, int shiftSize, ScreenAdapter screenAdapter){
