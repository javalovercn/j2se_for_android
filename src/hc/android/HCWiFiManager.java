...
//	}
	...
	static void enableWifiAp(final WifiManager wifiManager, final WifiConfiguration config, final boolean enable) {  
        try {  
            final Method method2 = wifiManager.getClass().getMethod("setWifiApEnabled", WifiConfiguration.class, boolean.class);  
	...
	public static boolean addAP(final WifiManager manager, final WifiConfiguration wcg, final String uuid, final int disappearSeconds){
	...
	public static WifiConfiguration createWifiInfo(final WifiManager manager, final String SSID, final String password, final String securityOption) {  
	...
	private final static Activity activity = ActivityManager.getActivity();
