...
public class HCTabHost extends LinearLayout {
	...
	public void clearAllTabs() {
		mTabSpecs.clear();
		rebuldWidget(ActivityManager.getActivity());
...
//		                    }
		...
		
		{
			...
			lp.gravity = (isLeftToRight ? Gravity.LEFT : Gravity.RIGHT)
					| Gravity.TOP;
	...
	public void addTab(String tag, Icon icon, String tip, View content, int idx) {
		...
		
		{
			...
			FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
					LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
			lp.gravity = (Gravity.TOP | (isLeftToRight ? Gravity.LEFT
					: Gravity.RIGHT));
...
//	        }
    ...
    public HCTabIndicatorView createIndicatorView(final HCTabSpec tabSpec) {
    	...
    	indView.init(isLeftToRight, btnEnabled, tabSpec.icon, tabSpec.tag, tabSpec.tip, this, mTabWidget);
