...
public class CanvasGraphics extends Graphics2D {
	 ...
	 * 
	 * @param canvas
	 * @param screenAdapter 通过AbstractBorder过来的，有可能为null
	 */
	...
	public Graphics create() {
		final BitmapGraphics bg = new BitmapGraphics(canvas.getWidth(), canvas.getHeight(), screenAdapter);
	...
	public void drawRoundRect(final int x, final int y, final int width, final int height,
    	...
    	canvas.drawRoundRect(new RectF(x, y, x+width-1, y+height-1), arcWidth / 2, arcHeight / 2, paint);
	}
	...
	public void fillRoundRect(final int x, final int y, final int width, final int height,
		...
		final Paint.Style oldStyle = paint.getStyle();
    	paint.setStyle(Paint.Style.FILL);
    	canvas.drawRoundRect(new RectF(x, y, x+width, y+height), arcWidth / 2, arcHeight / 2, paint);
    	paint.setStyle(oldStyle);
	}
	...
	public void drawArc(final int x, final int y, final int width, final int height, final int startAngle,
			final int arcAngle) {
		paint.setStyle(Paint.Style.STROKE);
    	canvas.drawArc(new RectF(x, y, x+width-1, y+height-1), startAngle, arcAngle, true, paint);
	}
	...
	private void drawSubString(final String str, final int offset, final int len, final float x, final float y) {
...
//		setColor(oldColor);
	...
	private void drawBitmap(final int dx1, final int dy1, final int dx2, final int dy2, final int sx1,
			final int sy1, final int sx2, final int sy2, final Bitmap bm) {
