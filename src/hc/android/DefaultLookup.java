...
public class DefaultLookup {
	public static final String TREE_LEAFICON = "Tree.leafIcon";
	public static final String TREE_CLOSEDICON = "Tree.closedIcon";
	public static final String TREE_OPENICON = "Tree.openIcon";
