...
public class AndroidClassUtil {
	...
	public static final void callEmptyMethod(){
		if(AndroidServerOption.displayEmptyMethodMessage){
			hc.util.ClassUtil.printCurrentThreadStack("--------Note : call an empty/unimplemented Swing/J2SE method---------", "callEmptyMethod");
		}
	}
	
	public static final void notifyReplaceWithSwingComponent(){
		hc.util.ClassUtil.printCurrentThreadStack("--------Note : This class is not provided, please use Swing Component!---------");
	}
...
//		dalvik.system.PathClassLoader myClassLoader = new dalvik.system.PathClassLoader(
...
//	 * @return 0 success
//	 */
//	public static int dx(String srcFileName, String toFileName) throws Exception{
