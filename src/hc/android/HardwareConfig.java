...
//	}
	...
	public static HardwareConfig getServerHardwareConfig(){
		if(serverHC == null){
			DisplayMetrics dm = ActivityManager.getActivity().getResources().getDisplayMetrics();     
			serverHC = new HardwareConfig(dm.widthPixels, dm.heightPixels, dm.densityDpi, dm.xdpi, dm.ydpi, dm.density, "", "");
		}
		return serverHC;
	}
	...
	public HardwareConfig(int cW, int cH, int dpi, float xdpi, float ydpi, float density, String cLang, String cVer){
		this.clientWidth = cW;
